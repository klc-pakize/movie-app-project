...
const MovieDetail = () => {
  ...
  return (
    <div className="container px-10 mx-auto py-5">
      <h1 className="text-center text-white text-3xl m-5">{title}</h1>
      <div className="container flex justify-center px-10">
        <div className="flex flex-col lg:flex-row max-w-6xl rounded-lg bg-gray-100 shadow-lg">
          <img
            className=" lg:w-1/3 h-97 lg:h-[600px] object-cover rounded-t-lg md:rounded-none md:rounded-l-lg"
          ...
          <div className="p-6 flex flex-col justify-between">
            ...
            <ul className="bg-gray-100 rounded-lg border border-gray-400 text-gray-900">
              ...
              <li className="px-6 py-2 border-gray-400 w-full rounded-t-lg">
                <Link
                  to={-1}
                  className="text-black-600 bg-gray-300 p-1 border-gray-400 rounded-lg hover:text-black-700 transition duration-300 ease-in-out mb-4"
                >
                  Go Back
                </Link>
              </li>
