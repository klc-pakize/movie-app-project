...
const Navbar = () => {
  // const currentUser = { displayName: "hello" };
  const { currentUser } = useContext(AuthContext);

  return (
    <>
      <nav className="navbar w-full flex flex-wrap items-center justify-between py-3 text-white shadow-lg navbar navbar-expand-lg fixed-top">
